...
public class WebManager {
    ...
    public static String getStableJarVersion() throws IOException {
        ...
        JsonElement main = new JsonParser().parse(IOUtils.toString(st.getInputStream(), StandardCharsets.UTF_8)).getAsJsonObject();
    ...
    public static String getCuttingEdgeJarFileUrl() throws IOException {
        ...
        JsonObject main = new JsonParser().parse(IOUtils.toString(st.getInputStream(), StandardCharsets.UTF_8));
        return main.getJSONObject(0).getAsJsonArray("assets").get(0).getAsJsonObject().get("browser_download_url").getAsString();
    }
